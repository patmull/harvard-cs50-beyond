...
class Flight(models.Model):
    ...
    origin = models.ForeignKey(Airport, on_delete=models.CASCADE, related_name='airport_origin')
    destination = models.ForeignKey(Airport, on_delete=models.CASCADE, related_name='airport_destination')
